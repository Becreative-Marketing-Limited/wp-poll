...
//					'type'    => 'radio',
//					'args'    => liquidpoll()->get_poll_types(),
//					'default' => array( 'poll' ),
//				),
//				array(
//					'id'            => 'poll_deadline',
...
//					'type'  => 'checkbox',
//					'args'  => apply_filters( 'liquidpoll_filters_allow_disallow_options', array(
...
//					'args'    => array(
//						'1' => sprintf( '%sassets/images/timer/style-1.jpg', LIQUIDPOLL_PLUGIN_URL ),
//						'2' => sprintf( '%sassets/images/timer/style-2.jpg', LIQUIDPOLL_PLUGIN_URL ),
//						'3' => sprintf( '%sassets/images/timer/style-3.jpg', LIQUIDPOLL_PLUGIN_URL ),
//						'4' => sprintf( '%sassets/images/timer/style-4.jpg', LIQUIDPOLL_PLUGIN_URL ),
//						'5' => sprintf( '%sassets/images/timer/style-5.jpg', LIQUIDPOLL_PLUGIN_URL ),
//					),
//					'default' => array( '1' ),
//				),
//				array(
...
//					'type'    => 'image_select',
//					'args'    => array(
//						'1'  => sprintf( '%sassets/images/themes/theme-1.jpg', LIQUIDPOLL_PLUGIN_URL ),
//						'2'  => sprintf( '%sassets/images/themes/theme-2.jpg', LIQUIDPOLL_PLUGIN_URL ),
//						'3'  => sprintf( '%sassets/images/themes/theme-3.jpg', LIQUIDPOLL_PLUGIN_URL ),
//						'4'  => sprintf( '%sassets/images/themes/theme-4.jpg', LIQUIDPOLL_PLUGIN_URL ),
//						'5'  => sprintf( '%sassets/images/themes/theme-5.jpg', LIQUIDPOLL_PLUGIN_URL ),
//						'6'  => sprintf( '%sassets/images/themes/theme-6.jpg', LIQUIDPOLL_PLUGIN_URL ),
//						'7'  => sprintf( '%sassets/images/themes/theme-7.jpg', LIQUIDPOLL_PLUGIN_URL ),
//						'8'  => sprintf( '%sassets/images/themes/theme-8.jpg', LIQUIDPOLL_PLUGIN_URL ),
//						'9'  => sprintf( '%sassets/images/themes/theme-9.jpg', LIQUIDPOLL_PLUGIN_URL ),
//						'10' => sprintf( '%sassets/images/themes/theme-10.jpg', LIQUIDPOLL_PLUGIN_URL ),
//						'11' => sprintf( '%sassets/images/themes/theme-11.jpg', LIQUIDPOLL_PLUGIN_URL ),
//					),
//					'default' => array( '1' ),
//				),
//				array(
...
//					'type'    => 'image_select',
//					'args'    => array(
//						'cross'     => sprintf( '%sassets/images/animations/cross.jpg', LIQUIDPOLL_PLUGIN_URL ),
//						'boxfill'   => sprintf( '%sassets/images/animations/boxfill.jpg', LIQUIDPOLL_PLUGIN_URL ),
//						'checkmark' => sprintf( '%sassets/images/animations/checkmark.jpg', LIQUIDPOLL_PLUGIN_URL ),
//						'diagonal'  => sprintf( '%sassets/images/animations/diagonal.jpg', LIQUIDPOLL_PLUGIN_URL ),
//					),
...
//					'type'    => 'image_select',
//					'args'    => array(
//						'fill'   => sprintf( '%sassets/images/animations/fill.jpg', LIQUIDPOLL_PLUGIN_URL ),
//						'circle' => sprintf( '%sassets/images/animations/circle.jpg', LIQUIDPOLL_PLUGIN_URL ),
//						'swirl'  => sprintf( '%sassets/images/animations/swirl.jpg', LIQUIDPOLL_PLUGIN_URL ),
//					),
//					'default' => array( 'fill' ),
//				),
//			);
...
//				return apply_filters( 'liquidpoll_filters_poll_meta_fields_' . $fields_for, $meta_fields[ $fields_for ] );
//			}
		...
		function get_plugin_settings() {
			...
			$pages['liquidpoll-options'] = array(
				'page_nav'      => esc_html__( 'Options', 'wp-poll' ),
				'page_settings' => apply_filters( 'liquidpoll_filters_settings_page_options', array(
					array(
					...
					array(
						...
						'options' => array(
							...
							array(
								'id'      => 'liquidpoll_archive_show_hide',
			...
			$pages['liquidpoll-pro']     = array(
				...
				'page_settings' => apply_filters( 'liquidpoll_filters_settings_page_pro', array(
					array(
						...
						'options' => array(
							array(
								'id'       => 'liquidpoll_disabled_options',
			...
			$pages['liquidpoll-support'] = array(
				'page_nav'      => esc_html__( 'Support', 'wp-poll' ),
				'show_submit'   => false,
				'page_settings' => apply_filters( 'liquidpoll_filters_settings_page_support', array(
					...
					'sec_options' => array(
						...
						'options' => array(
							...
							array(
								'id'      => 'liquidpoll_ticket',
								'title'   => esc_html__( 'Support Ticket', 'wp-poll' ),
								'details' => sprintf( '<a href="%s" target="_blank">%s</a>', LIQUIDPOLL_TICKET_URL, esc_html__( 'Create Ticket', 'wp-poll' ) ),
							),
							array(
								'id'      => 'liquidpoll_review',
			...
			return apply_filters( 'liquidpoll_filters_settings_pages', $pages );
		}
