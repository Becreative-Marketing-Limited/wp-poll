...
;(function ($, window, document, undefined) {
    ...
    PBSettings.helper = {
        ...
        name_nested_replace: function ($selector, field_id) {
            ...
            var checks = [];
            var regex = new RegExp(PBSettings.helper.preg_quote(field_id + '[\\d+]'), 'g');
    ...
    // Expand All Options
    //
    $.fn.pb_settings_expand_all = function () {
    ...
    // Options Navigation
    //
    $.fn.pb_settings_nav_options = function () {
        return this.each(function () {
            ...
            $window.on('hashchange pb_settings.hashchange', function () {
            ...
            }).trigger('pb_settings.hashchange');
    ...
    // Metabox Tabs
    //
    $.fn.pb_settings_nav_metabox = function () {
        return this.each(function () {
    ...
    //
    $.fn.pb_settings_page_templates = function () {
        if (this.length) {
    ...
    //
    $.fn.pb_settings_post_formats = function () {
        if (this.length) {
    ...
    // Search
    //
    $.fn.pb_settings_search = function () {
        return this.each(function () {
    ...
    // Sticky Header
    //
    $.fn.pb_settings_sticky = function () {
        return this.each(function () {
    ...
    // Dependency System
    //
    $.fn.pb_settings_dependency = function () {
        return this.each(function () {
            ...
            if ($fields.length) {
                ...
                var normal_ruleset = $.pb_settings_deps.createRuleset(),
                    global_ruleset = $.pb_settings_deps.createRuleset(),
                    normal_depends = [],
                    global_depends = [];
                ...
                if (normal_depends.length) {
                    $.pb_settings_deps.enable($this, normal_ruleset, normal_depends);
                }

                if (global_depends.length) {
                    $.pb_settings_deps.enable(PBSettings.vars.$body, global_ruleset, global_depends);
                }
    ...
    // Field: backup
    //
    $.fn.pb_settings_field_backup = function () {
        return this.each(function () {
            ...
            base.notificationOverlay = function () {
                ...
                if (wp.customize.notifications && wp.customize.OverlayNotification) {
                    ...
                    wp.customize.notifications.add(new wp.customize.OverlayNotification('pb_settings_field_backup_notification', {
                        type: 'default',
                        message: '&nbsp;',
                        loading: true
                    }));
                ...
                if (PBSettings.vars.is_confirm) {
                    ...
                    window.wp.ajax.post('pbsettings-reset', {
                        ...
                        .fail(function (response) {
                            ...
                            wp.customize.notifications.remove('pb_settings_field_backup_notification');
                        });
    ...
    // Field: code_editor
    //
    $.fn.pb_settings_field_code_editor = function () {
        return this.each(function () {
            ...
            var interval = setInterval(function () {
                if ($this.is(':visible')) {
                    ...
                    if (data_editor.theme !== 'default' && PBSettings.vars.code_themes.indexOf(data_editor.theme) === -1) {
                        ...
                        PBSettings.vars.code_themes.push(data_editor.theme);
    ...
    // Field: date
    //
    $.fn.pb_settings_field_date = function () {
        return this.each(function () {
    ...
    // Field: datetime
    //
    $.fn.pb_settings_field_datetime = function () {
        return this.each(function () {
    ...
    // Field: gallery
    //
    $.fn.pb_settings_field_gallery = function () {
        return this.each(function () {
    ...
    // Field: group
    //
    $.fn.pb_settings_field_group = function () {
        return this.each(function () {
                ...
                activate: function (event, ui) {
                    ...
                    if ($panel.length && !$panel.data('opened')) {
                        ...
                        $.each(inputs, function (key, $input) {
                            ...
                            $input.on('change keyup pb_settings.keyup', function () {
                            ...
                            }).trigger('pb_settings.keyup');

                        });

                        $panel.pb_settings_reload_script();
                        $panel.data('opened', true);
                        $panel.data('retry', false);

                    } else if ($panel.data('retry')) {

                        $panel.pb_settings_reload_script_retry();
                        $panel.data('retry', false);
            ...
            $wrapper.sortable({
                ...
                update: function (event, ui) {
                    ...
                    PBSettings.helper.name_nested_replace($wrapper.children('.pbsettings-cloneable-item'), field_id);
    ...
    // Field: icon
    //
    $.fn.pb_settings_field_icon = function () {
        return this.each(function () {
            ...
            $this.on('click', '.pbsettings-icon-add', function (e) {
                ...
                PBSettings.vars.$icon_target = $this;

                if (!PBSettings.vars.icon_modal_loaded) {
                    ...
                    window.wp.ajax.post('pbsettings-get-icons', {
                        ...
                        PBSettings.vars.icon_modal_loaded = true;
                        ...
                        $load.on('click', 'i', function (e) {
                            ...
                            PBSettings.vars.$icon_target.find('.pbsettings-icon-preview i').removeAttr('class').addClass(icon);
                            PBSettings.vars.$icon_target.find('.pbsettings-icon-preview').removeClass('hidden');
                            PBSettings.vars.$icon_target.find('.pbsettings-icon-remove').removeClass('hidden');
                            PBSettings.vars.$icon_target.find('input').val(icon).trigger('change');
    ...
    // Field: map
    //
    $.fn.pb_settings_field_map = function () {
        return this.each(function () {
    ...
    // Field: link
    //
    $.fn.pb_settings_field_link = function () {
        return this.each(function () {
            ...
            var $this = $(this),
                ...
                uniqid = PBSettings.helper.uid('pbsettings-wplink-textarea-');
    ...
    // Field: media
    //
    $.fn.pb_settings_field_media = function () {
        return this.each(function () {
    ...
    // Field: repeater
    //
    $.fn.pb_settings_field_repeater = function () {
        return this.each(function () {
            ...
            $wrapper.sortable({
                ...
                update: function (event, ui) {
                    ...
                    PBSettings.helper.name_nested_replace($wrapper.children('.pbsettings-repeater-item'), field_id);
                    $wrapper.pb_settings_customizer_refresh();
    ...
    // Field: slider
    //
    $.fn.pb_settings_field_slider = function () {
        return this.each(function () {
    ...
    $.fn.pb_settings_field_sortable = function () {
        return this.each(function () {
            ...
            $sortable.sortable({
                ...
                placeholder: 'widget-placeholder',
                update: function (event, ui) {
                    $sortable.pb_settings_customizer_refresh();
                }
            });
    ...
    // Field: sorter
    //
    $.fn.pb_settings_field_sorter = function () {
        return this.each(function () {
            ...
            $enabled.sortable({
                ...
                update: function (event, ui) {
                    ...
                    $this.pb_settings_customizer_refresh();
    ...
    // Field: spinner
    //
    $.fn.pb_settings_field_spinner = function () {
        return this.each(function () {
    ...
    // Field: tabbed
    //
    $.fn.pb_settings_field_tabbed = function () {
        return this.each(function () {
    ...
    // Field: typography
    //
    $.fn.pb_settings_field_typography = function () {
        return this.each(function () {

            var base = this;
            var $this = $(this);
            var loaded_fonts = [];
            var webfonts = pb_settings_typography_json.webfonts;
            var googlestyles = pb_settings_typography_json.googlestyles;
            var defaultstyles = pb_settings_typography_json.defaultstyles;
            ...
            base.append_select_options = function ($select, options, condition, type, is_multi) {
                ...
                $select.append(opts).trigger('pb_settings.change').trigger('chosen:updated');
            ...
            base.init = function () {
                ...
                if ($font_style_block.length) {
                    ...
                    $font_style_select.on('change pb_settings.change', function (event) {
                ...
                $font_family_select.on('change pb_settings.change', function (event) {
                ...
                if ($preview_block.length) {
                    ...
                    $this.on('change', PBSettings.helper.debounce(function (event) {
    ...
    // Field: upload
    //
    $.fn.pb_settings_field_upload = function () {
        return this.each(function () {
    ...
    // Field: wp_editor
    //
    $.fn.pb_settings_field_wp_editor = function () {
        return this.each(function () {

            if (typeof window.wp.editor === 'undefined' || typeof window.tinyMCEPreInit === 'undefined' || typeof window.tinyMCEPreInit.mceInit.pb_settings_wp_editor === 'undefined') {
                return;
            }
            ...
            var uid = PBSettings.helper.uid('pbsettings-editor-');

            $textarea.attr('id', uid);

            // Get default editor settings
            var default_editor_settings = {
                tinymce: window.tinyMCEPreInit.mceInit.pb_settings_wp_editor,
                quicktags: window.tinyMCEPreInit.qtInit.pb_settings_wp_editor
            };
            ...
            // Add Media buttons
            if (field_editor_settings.media_buttons && window.pb_settings_media_buttons) {
    ...
    // Confirm
    //
    $.fn.pb_settings_confirm = function () {
        return this.each(function () {
            $(this).on('click', function (e) {

                var confirm_text = $(this).data('confirm') || window.pb_settings_vars.i18n.confirm;
                var confirm_answer = confirm(confirm_text);

                if (confirm_answer) {
                    PBSettings.vars.is_confirm = true;
                    PBSettings.vars.form_modified = false;
                } else {
                    e.preventDefault();
                    return false;
                }
                ...
                if (!flooding) {
                    ...
                    if ($this.hasClass('pbsettings-save-ajax')) {
                        ...
                        window.wp.ajax.post('pb_settings_' + $panel.data('unique') + '_ajax_save', {
                            data: $('#pbsettings-form').serializeJSONPBSettings()
                        })
                            .done(function (response) {
                                ...
                                PBSettings.vars.form_modified = false;
                                PBSettings.vars.$form_warning.hide();
    ...
    // Option Framework
    //
    $.fn.pb_settings_options = function () {
        return this.each(function () {
            ...
            PBSettings.vars.$form_warning = $form_warning;

            // Shows a message white leaving theme options without saving
            if ($form_warning.length) {

                window.onbeforeunload = function () {
                    return (PBSettings.vars.form_modified) ? true : undefined;
                };

                $content.on('change keypress', ':input', function () {
                    if (!PBSettings.vars.form_modified) {
                        $form_success.hide();
                        $form_warning.fadeIn('fast');
                        PBSettings.vars.form_modified = true;
                    }
                });
    ...
    // Taxonomy Framework
    //
    $.fn.pb_settings_taxonomy = function () {
        return this.each(function () {
            ...
            if ($form.attr('id') === 'addtag') {
                ...
                $submit.on('click', function () {
                    ...
                    if (!$form.find('.form-required').hasClass('form-invalid')) {
                        ...
                        $cloned = $cloned.pb_settings_clone();

                        $this.pb_settings_reload_script();
    ...
    // Shortcode Framework
    //
    $.fn.pb_settings_shortcode = function () {
        ...
        return this.each(function () {
            ...
            $insert.on('click', function (e) {
                ...
                var shortcode = '';
                var serialize = $modal.find('.pbsettings-field:not(.pbsettings-depend-on)').find(':input:not(.ignore)').serializeObjectPBSettings();
                ...
                if (gutenberg_id) {
                    ...
                    var content = window.pb_settings_gutenberg_props.attributes.hasOwnProperty('shortcode') ? window.pb_settings_gutenberg_props.attributes.shortcode : '';
                    window.pb_settings_gutenberg_props.setAttributes({shortcode: content + shortcode});
            ...
            $modal.on('click', '.pbsettings--repeat-button', function (e) {
                ...
                PBSettings.helper.name_nested_replace($modal.find('.pbsettings--repeat-shortcode'), sc_group);
    ...
    PBSettings.funcs.parse_color = function (color) {
    ...
    $.fn.pb_settings_color = function () {
        return this.each(function () {

            var $input = $(this),
                picker_color = PBSettings.funcs.parse_color($input.val()),
                palette_color = window.pb_settings_vars.color_palette.length ? window.pb_settings_vars.color_palette : true,
                $container;
                    ...
                    $transparent_slider.slider({
                        ...
                        create: function () {
                            ...
                            $container.on('click', '.wp-picker-default', function () {
                                ...
                                var default_color = PBSettings.funcs.parse_color($input.data('default-color')),
    ...
    // ChosenJS
    //
    $.fn.pb_settings_chosen = function () {
        return this.each(function () {
            ...
            var $this = $(this),
                ...
                set_options = $.extend({
                    ...
                    width: set_width,
                    no_results_text: window.pb_settings_vars.i18n.no_results_text,
            ...
            if (is_ajax) {
                ...
                var set_ajax_options = $.extend({
                    ...
                    min_length: 3,
                    type_delay: 500,
                    typing_text: window.pb_settings_vars.i18n.typing_text,
                    searching_text: window.pb_settings_vars.i18n.searching_text,
                    no_results_text: window.pb_settings_vars.i18n.no_results_text,
                }, $this.data('chosen-settings'));

                $this.PBSettingsAjaxChosen(set_ajax_options);
            ...
            if (is_multiple) {
                ...
                $this.PBSettingsChosenOrder($hidden_value, true);
    ...
    //
    $.fn.pb_settings_checkbox = function () {
        return this.each(function () {
    ...
    // Siblings
    //
    $.fn.pb_settings_siblings = function () {
        return this.each(function () {
        ...
        return this.each(function () {
            ...
            $this.on({
                mouseenter: function () {
                    ...
                    offset_left = (PBSettings.vars.is_rtl) ? ($this.offset().left + 24) : ($this.offset().left - $tooltip.outerWidth());
    ...
    // Customize Refresh
    //
    $.fn.pb_settings_customizer_refresh = function () {
        return this.each(function () {
            ...
            if ($complex.length) {
                ...
                var $input = $complex.find(':input'),
                    ...
                    obj = $input.serializeObjectPBSettings(),
    ...
    //
    $.fn.pb_settings_customizer_listen = function (options) {
        ...
        return this.each(function () {
            ...
            $input.on('change keyup pb_settings.change', function () {

                var obj = $this.find(':input').serializeObjectPBSettings();
    ...
    $(document).on('expanded', '.control-section', function () {
        ...
        if ($this.hasClass('open') && !$this.data('inited')) {
            ...
            if ($fields.length) {
                ...
                $fields.pb_settings_reload_script({dependency: false});
                $complex.pb_settings_customizer_listen();
            }
    ...
    // Window on resize
    //
    PBSettings.vars.$window.on('resize pb_settings.resize', PBSettings.helper.debounce(function (event) {

        var window_width = navigator.userAgent.indexOf('AppleWebKit/') > -1 ? PBSettings.vars.$window.width() : window.innerWidth;

        if (window_width <= 782 && !PBSettings.vars.onloaded) {
            $('.pbsettings-section').pb_settings_reload_script();
            PBSettings.vars.onloaded = true;
        }

    }, 200)).trigger('pb_settings.resize');

    //
    // Widgets Framework
    //
    $.fn.pb_settings_widgets = function () {
        return this.each(function () {
    ...
    //
    $.fn.pb_settings_nav_menu = function () {
        return this.each(function () {
    ...
    // Retry Plugins
    //
    $.fn.pb_settings_reload_script_retry = function () {
        return this.each(function () {
    ...
    // Reload Plugins
    //
    $.fn.pb_settings_reload_script = function (options) {
