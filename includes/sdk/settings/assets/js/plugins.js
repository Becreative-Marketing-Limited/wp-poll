...
(function($) {
  ...
  function PBSettingsAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  PBSettingsAjaxChosen.prototype.init = function() {
  ...
  PBSettingsAjaxChosen.prototype.events = function() {
  ...
  PBSettingsAjaxChosen.prototype.search_field_focused = function() {
  ...
  PBSettingsAjaxChosen.prototype.search_welcome_message = function() {
  ...
  PBSettingsAjaxChosen.prototype.update_list = function() {
  ...
  PBSettingsAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      this.element.PBSettingsChosenOrder($hidden_value, true);
  ...
  $.fn.PBSettingsAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new PBSettingsAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, PBSettingsAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  PBSettingsAbstractChosenOrder = (function() {

    function PBSettingsAbstractChosenOrder() {}

    PBSettingsAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    PBSettingsAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    PBSettingsAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    PBSettingsAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    PBSettingsAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    PBSettingsAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    PBSettingsAbstractChosenOrder.PBSettingsChosenOrder = function(select, order, force) {
    ...
    return PBSettingsAbstractChosenOrder;
  ...
  $.fn.extend({
    PBSettingsChosenOrder: function(order, force) {
      return _PBSettingsChosenOrder.PBSettingsChosenOrder(this, order, force);
    }
  });

  this._PBSettingsChosenOrder = (function(_super) {
    __extends(_PBSettingsChosenOrder, _super);

    function _PBSettingsChosenOrder() {
      _ref = _PBSettingsChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _PBSettingsChosenOrder.relAttributeName = 'data-option-array-index';

    _PBSettingsChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _PBSettingsChosenOrder.getDOMElement = function(element) {
    ...
    _PBSettingsChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _PBSettingsChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _PBSettingsChosenOrder;

  })(PBSettingsAbstractChosenOrder);
...
(function(root, factory) {
  ...
  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectPBSettings = FormSerializer.serializeObject;
    $.fn.serializeJSONPBSettings   = FormSerializer.serializeJSON;
  }
