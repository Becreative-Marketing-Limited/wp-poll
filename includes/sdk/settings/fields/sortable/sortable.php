 ...
 *
 */
if ( ! class_exists( 'PBSettings_Field_sortable' ) ) {
  class PBSettings_Field_sortable extends PBSettings_Fields {
    ...
    public function render() {
      ...
      foreach ( $pre_sortby as $key => $field ) {
        ...
        echo '<div class="pbsettings-sortable-item">';
          ...
          PBSettings::field( $field, $field_value, $unique_id, 'field/sortable' );
