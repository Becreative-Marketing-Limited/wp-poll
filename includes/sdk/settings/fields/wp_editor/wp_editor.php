 ...
 *
 */
if ( ! class_exists( 'PBSettings_Field_wp_editor' ) ) {
  class PBSettings_Field_wp_editor extends PBSettings_Fields {
    ...
    public function enqueue() {
      ...
      if ( pb_settings_wp_editor_api() && function_exists( 'wp_enqueue_editor' ) ) {
    ...
    public function setup_wp_editor_media_buttons() {
      ...
      echo 'var pb_settings_media_buttons = '. json_encode( $media_buttons ) .';';
      echo '</script>';
    ...
    public function setup_wp_editor_settings() {
      ...
      if ( pb_settings_wp_editor_api() && class_exists( '_WP_Editors') ) {
        ...
        $setup = _WP_Editors::parse_settings( 'pb_settings_wp_editor', $defaults );

        _WP_Editors::editor_settings( 'pb_settings_wp_editor', $setup );
