 ...
 *
 */
if ( ! class_exists( 'PBSettings_Field_group' ) ) {
  class PBSettings_Field_group extends PBSettings_Fields {
      ...
      if ( preg_match( '/'. preg_quote( '['. $this->field['id'] .']' ) .'/', $this->unique ) ) {
        ...
        echo '<div class="pbsettings-cloneable-item pbsettings-cloneable-hidden" data-depend-id="'. esc_attr( $this->field['id'] ) .'">';
          ...
          foreach ( $this->field['fields'] as $field ) {
            ...
            PBSettings::field( $field, $field_default, '___'. $field_unique, 'field/group' );
          ...
          foreach ( $this->value as $value ) {
            ...
            echo '<div class="pbsettings-cloneable-item">';
              ...
              foreach ( $this->field['fields'] as $field ) {
                ...
                PBSettings::field( $field, $field_value, $field_unique, 'field/group' );
