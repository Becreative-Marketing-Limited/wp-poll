 ...
 *
 */
if ( ! class_exists( 'PBSettings_Field_accordion' ) ) {
  class PBSettings_Field_accordion extends PBSettings_Fields {
      ...
      foreach ( $this->field['accordions'] as $key => $accordion ) {
        ...
        echo '<div class="pbsettings-accordion-item">';
          ...
          foreach ( $accordion['fields'] as $field ) {
            ...
            PBSettings::field( $field, $field_value, $unique_id, 'field/accordion' );
