 ...
 *
 */
if ( ! class_exists( 'PBSettings_Field_icon' ) ) {
  class PBSettings_Field_icon extends PBSettings_Fields {
    ...
    public function enqueue() {
      add_action( 'admin_footer', array( 'PBSettings_Field_icon', 'add_footer_modal_icon' ) );
      add_action( 'customize_controls_print_footer_scripts', array( 'PBSettings_Field_icon', 'add_footer_modal_icon' ) );
    }
