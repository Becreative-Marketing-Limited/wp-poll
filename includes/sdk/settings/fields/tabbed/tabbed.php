 ...
 *
 */
if ( ! class_exists( 'PBSettings_Field_tabbed' ) ) {
  class PBSettings_Field_tabbed extends PBSettings_Fields {
    ...
    public function render() {
      ...
      foreach ( $this->field['tabs'] as $key => $tab ) {
        ...
        foreach ( $tab['fields'] as $field ) {
          ...
          PBSettings::field( $field, $field_value, $unique_id, 'field/tabbed' );
