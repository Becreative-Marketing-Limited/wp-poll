 ...
 *
 */
if ( ! class_exists( 'WP_Customize_Panel_PBSettings' ) && class_exists( 'WP_Customize_Panel' ) ) {
	class WP_Customize_Panel_PBSettings extends WP_Customize_Panel {
 ...
 *
 */
if ( ! class_exists( 'WP_Customize_Section_PBSettings' ) && class_exists( 'WP_Customize_Section' ) ) {
	class WP_Customize_Section_PBSettings extends WP_Customize_Section {
		public $type = 'pb_settings';
	}
}
 ...
 *
 */
if ( ! class_exists( 'WP_Customize_Control_PBSettings' ) && class_exists( 'WP_Customize_Control' ) ) {
	class WP_Customize_Control_PBSettings extends WP_Customize_Control {
		...
		public function render_field_content() {
			...
			PBSettings::field( $this->field, $this->value(), $this->unique, 'customize' );
