 ...
 *
 */
if ( ! class_exists( 'PBSettings_Metabox' ) ) {
	class PBSettings_Metabox extends PBSettings_Abstract {
			...
			foreach ( $this->sections as $section ) {
				...
				if ( ! empty( $section['fields'] ) ) {
					...
					foreach ( $section['fields'] as $field ) {
						...
						PBSettings::field( $field, $this->get_meta_value( $field ), $this->unique, 'metabox' );
