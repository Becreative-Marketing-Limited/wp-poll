...
<?php if( $options_style == 10 ) : ?>
    <div class="wpp-custom wpp-checkbox wpp-checkmark wpp-option-list-10">
        ...
        <div class="wpp-option-single">
            <input type="checkbox" name="newzealand2" id="newzealand2">
            <label for="newzealand2">New Zealand</label>
        </div>
    </div>
<?php endif; ?>
...
<?php if( $options_style == 10 ) : ?>
    ...
    <div class="wpp-custom wpp-radio wpp-circle wpp-option-list-10">
        ...
        <div class="wpp-option-single"><input id="r44" name="r44" type="radio"><label for="r44">Energistically scale future-proof core competencies</label></div>
    </div>
<?php endif; ?>
...
<?php if( $options_style == 10 ) : ?>
    <div class="wpp-custom wpp-checkbox wpp-boxfill wpp-option-list-10">
        ...
        <div class="wpp-option-single">
            <input type="checkbox" name="newzealand4" id="newzealand4">
            <label for="newzealand4">New Zealand</label>
        </div>
    </div>
<?php endif; ?>
...
<?php if( $options_style == 10 ) : ?>
    ...
    <div class="wpp-custom wpp-radio wpp-swirl wpp-option-list-10">
        ...
        <div class="wpp-option-single"><input id="r444" name="r444" type="radio"><label for="r444">Energistically scale future-proof core competencies</label></div>
    </div>
<?php endif; ?>
...
<?php if( $options_style == 10 ) : ?>
    <div class="wpp-custom wpp-checkbox wpp-diagonal wpp-option-list-10">
        ...
        <div class="wpp-option-single">
            <input type="checkbox" name="newzealand3" id="newzealand3">
            <label for="newzealand3">New Zealand</label>
        </div>
    </div>
<?php endif; ?>
