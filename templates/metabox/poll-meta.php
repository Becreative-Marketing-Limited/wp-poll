...
$wppoll_sdk->Settings()->render_panel( array(
	...
	'footer_menu' => array(
		array(
			...
			'url'   => esc_url(WPP_TICKET_URL),
		),
		array(
			'label' => esc_html__( 'Docs', 'wp-poll' ),
			'url'   => esc_url(WPP_DOCS_URL),
		),
		array(
			'label' => esc_html__( 'Get Pro', 'wp-poll' ),
			'url'   => esc_url(WPP_PLUGIN_LINK),
		),
	),
	'post_id'     => $post->ID,
) );
...
<div class="wpp-poll-meta">
    <div class="meta-sidebar">
        <div class="header"><img src="<?php echo esc_url( WPP_PLUGIN_URL . 'assets/images/wp-poll.svg' ); ?>" alt="<?php echo esc_html__( 'Poll Logo', 'wp-poll' ); ?>"></div>
        <ul class="meta-nav">
            <li class="active" data-target="tab-content-general"><?php echo esc_html__( 'General Data', 'wp-poll' ); ?></li>
            <li data-target="tab-content-options"><?php echo esc_html__( 'Options', 'wp-poll' ); ?></li>
            <li data-target="tab-content-designs"><?php echo esc_html__( 'Designs', 'wp-poll' ); ?></li>
            <li data-target="tab-content-settings"><?php echo esc_html__( 'Settings', 'wp-poll' ); ?></li>
            <li data-target="tab-content-results"><?php echo esc_html__( 'Results', 'wp-poll' ); ?></li>
            <li data-target="tab-content-manipulate"><?php echo esc_html__( 'Manipulate Results', 'wp-poll' ); ?></li>
        </ul>
        <div class="footer">
            <a class="footer-link" href="<?php echo esc_url( WPP_TICKET_URL ); ?>" target="_blank"><?php echo esc_html__( 'Ticket', 'wp-poll' ); ?></a>
            <a class="footer-link" href="<?php echo esc_url( WPP_DOCS_URL ); ?>" target="_blank"><?php echo esc_html__( 'Doc', 'wp-poll' ); ?></a>
            <a class="footer-link" href="<?php echo esc_url( WPP_PLUGIN_LINK ); ?>" target="_blank"><?php echo esc_html__( 'Get Pro', 'wp-poll' ); ?></a>
        </div>
    </div>
    ...
    <div class="meta-content">
        <div class="tab-content-item tab-content-general active">
            ...
            <div class="item-wrap">
				<?php global $wppoll_sdk; $wppoll_sdk->Settings()->generate_fields( $post->ID ); ?>
            </div>
        </div>
        ...
        <div class="tab-content-item tab-content-options">
            ...
            <div class="item-wrap">
				<?php global $wppoll_sdk; $wppoll_sdk->Settings()->generate_fields( $meta_box->get_meta_fields( 'options' ), $post->ID ); ?>
            </div>
        </div>
        ...
        <div class="tab-content-item tab-content-designs">
            ...
            <div class="item-wrap">
				<?php global $wppoll_sdk; $wppoll_sdk->Settings()->generate_fields( $meta_box->get_meta_fields( 'designs' ), $post->ID ); ?>
            </div>
        </div>
        ...
        <div class="tab-content-item tab-content-settings">
            ...
            <div class="item-wrap">
				<?php global $wppoll_sdk; $wppoll_sdk->Settings()->generate_fields( $meta_box->get_meta_fields( 'settings' ), $post->ID ); ?>
            </div>
        </div>
